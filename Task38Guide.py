'''Выполнить телефонный справочник с учетом модульности'''
...
try:
    ...
    print('Создан новый справочник -> Sample.txt ')
    file = open(path, 'w')
finally:
    file.close()
